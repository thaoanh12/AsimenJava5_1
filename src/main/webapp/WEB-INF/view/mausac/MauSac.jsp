...
<div style="margin-left: 20px ; margin-top: 10px">
    ...
    <form method="post" action="/mau-sac/add">
        ...
        <p style="color: red">${thongBao}</p>
        <button>Add</button>
        <button formaction="/mau-sac/update">update</button>
    </form>
    <button><a href="/mau-sac/hien-thi">hiển thị </a></button>
    <br>
    <table>
        <tr>
            <td>id</td>
        ...
        <c:forEach var="nsx" items="${nsx.content}">
            <tr>
                ...
                <td>${nsx.ten}</td>
                <td>
                    <button><a href="/mau-sac/remover/${nsx.id}">delete</a></button>
                    <button><a href="/mau-sac/detail/${nsx.id}">detail</a></button>
                </td>
            </tr>
        </c:forEach>
    </table>
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?p=0">Fist</a></li>
            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?p=${nsx.number - 1}">Back</a></li>
            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?p=${nsx.number + 1}">Next</a></li>
            <li class="page-item"><a class="page-link" href="/mau-sac/hien-thi?p=${nsx.totalPages - 1}">Last</a></li>
        </ul>
    </nav>
</div>
