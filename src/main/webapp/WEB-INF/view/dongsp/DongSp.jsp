...
<div style="margin-left: 20px ; margin-top: 10px">
    ...
    <button><a href="/dongsp/hien-thi">hiển thị </a></button>
    <br>
    <table>
        <tr>
            <td>id</td>
        ...
        <c:forEach var="nsx" items="${nsx.content}">
            <tr>
                ...
                <td>${nsx.ten}</td>
                <td>
                    <button><a href="/dongsp/remover/${nsx.id}">delete</a></button>
                    <button><a href="/dongsp/detail/${nsx.id}">detail</a></button>
                </td>
            </tr>
        </c:forEach>
    </table>
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <li class="page-item"><a class="page-link" href="/dongsp/hien-thi?p=0">Fist</a></li>
            <li class="page-item"><a class="page-link" href="/dongsp/hien-thi?p=${nsx.number - 1}">Back</a></li>
            <li class="page-item"><a class="page-link" href="/dongsp/hien-thi?p=${nsx.number + 1}">Next</a></li>
            <li class="page-item"><a class="page-link" href="/dongsp/hien-thi?p=${nsx.totalPages - 1}">Last</a></li>
        </ul>
    </nav>
</div>
